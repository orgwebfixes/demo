...
$(function() {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            // Init
            var sales = ec.init(document.getElementById('sales'), PSK);
            var visits = ec.init(document.getElementById('visits'), PSK);
            var plans = ec.init(document.getElementById('plans'), PSK);
