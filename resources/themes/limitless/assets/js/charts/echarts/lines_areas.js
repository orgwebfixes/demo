...
$(function() {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var basic_lines = ec.init(document.getElementById('basic_lines'), PSK);
            var stacked_lines = ec.init(document.getElementById('stacked_lines'), PSK);
            var inverted_axes = ec.init(document.getElementById('inverted_axes'), PSK);
            var line_point = ec.init(document.getElementById('line_point'), PSK);
            var basic_area = ec.init(document.getElementById('basic_area'), PSK);
            var stacked_area = ec.init(document.getElementById('stacked_area'), PSK);
            var reversed_value = ec.init(document.getElementById('reversed_value'), PSK);
