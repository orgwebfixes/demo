...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var candlestick_basic = ec.init(document.getElementById('candlestick_basic'), PSK);
            var candlestick_line = ec.init(document.getElementById('candlestick_line'), PSK);
            var candlestick_scatter = ec.init(document.getElementById('candlestick_scatter'), PSK);

            var radar_basic = ec.init(document.getElementById('radar_basic'), PSK);
            var radar_filled = ec.init(document.getElementById('radar_filled'), PSK);

            var gauge_basic = ec.init(document.getElementById('gauge_basic'), PSK);
            var gauge_styling = ec.init(document.getElementById('gauge_styling'), PSK);
