...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var basic_columns = ec.init(document.getElementById('basic_columns'), PSK);
            var stacked_columns = ec.init(document.getElementById('stacked_columns'), PSK);
            var stacked_clustered_columns = ec.init(document.getElementById('stacked_clustered_columns'), PSK);
            var thermometer_columns = ec.init(document.getElementById('thermometer_columns'), PSK);
            var compositive_waterfall = ec.init(document.getElementById('compositive_waterfall'), PSK);
            var change_waterfall = ec.init(document.getElementById('change_waterfall'), PSK);
            var columns_timeline = ec.init(document.getElementById('columns_timeline'), PSK);
