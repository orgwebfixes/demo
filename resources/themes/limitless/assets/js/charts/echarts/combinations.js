...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var line_bar = ec.init(document.getElementById('line_bar'), PSK);
            var column_pie = ec.init(document.getElementById('column_pie'), PSK);
            var scatter_pie = ec.init(document.getElementById('scatter_pie'), PSK);
            var scatter_line = ec.init(document.getElementById('scatter_line'), PSK);

            var connect_pie = ec.init(document.getElementById('connect_pie'), PSK);
            var connect_column = ec.init(document.getElementById('connect_column'), PSK);

            var candlestick_scatter = ec.init(document.getElementById('candlestick_scatter'), PSK);
