...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var funnel_asc = ec.init(document.getElementById('funnel_asc'), PSK);
            var funnel_desc = ec.init(document.getElementById('funnel_desc'), PSK);
            var funnel_left = ec.init(document.getElementById('funnel_left'), PSK);
            var funnel_right = ec.init(document.getElementById('funnel_right'), PSK);
            var funnel_multiple_overlay = ec.init(document.getElementById('funnel_multiple_overlay'), PSK);
            var funnel_multiple_separate = ec.init(document.getElementById('funnel_multiple_separate'), PSK);

            var chord_basic = ec.init(document.getElementById('chord_basic'), PSK);
            var chord_sorting = ec.init(document.getElementById('chord_sorting'), PSK);
            var chord_non_ribbon = ec.init(document.getElementById('chord_non_ribbon'), PSK);
            var chord_scale = ec.init(document.getElementById('chord_scale'), PSK);
