...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var basic_bars = ec.init(document.getElementById('basic_bars'), PSK);
            var stacked_bars = ec.init(document.getElementById('stacked_bars'), PSK);
            var stacked_clustered_bars = ec.init(document.getElementById('stacked_clustered_bars'), PSK);
            var floating_bars = ec.init(document.getElementById('floating_bars'), PSK);
            var irregular_bars = ec.init(document.getElementById('irregular_bars'), PSK);
            var tornado_bars_negative = ec.init(document.getElementById('tornado_bars_negative'), PSK);
            var tornado_bars_staggered = ec.init(document.getElementById('tornado_bars_staggered'), PSK);
