...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var basic_scatter = ec.init(document.getElementById('basic_scatter'), PSK);
            var bubble_size = ec.init(document.getElementById('bubble_size'), PSK);
            var large_scale = ec.init(document.getElementById('large_scale'), PSK);
            var scale_roaming = ec.init(document.getElementById('scale_roaming'), PSK);
            var category_scatter = ec.init(document.getElementById('category_scatter'), PSK);
            var time_data = ec.init(document.getElementById('time_data'), PSK);
            var timeline_scatter = ec.init(document.getElementById('timeline_scatter'), PSK);
