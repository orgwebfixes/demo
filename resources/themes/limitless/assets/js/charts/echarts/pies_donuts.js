...
$(function () {
    ...
    require(
        ...
        function (ec, PSK) {
            ...
            var basic_pie = ec.init(document.getElementById('basic_pie'), PSK);
            var basic_donut = ec.init(document.getElementById('basic_donut'), PSK);
            var nested_pie = ec.init(document.getElementById('nested_pie'), PSK);
            var infographic_donut = ec.init(document.getElementById('infographic_donut'), PSK);
            var rose_diagram_hidden = ec.init(document.getElementById('rose_diagram_hidden'), PSK);
            var rose_diagram_visible = ec.init(document.getElementById('rose_diagram_visible'), PSK);
            var lasagna_donut = ec.init(document.getElementById('lasagna_donut'), PSK);
            var pie_timeline = ec.init(document.getElementById('pie_timeline'), PSK);
            var multiple_donuts = ec.init(document.getElementById('multiple_donuts'), PSK);
