                        ...
                        <thead>
                            ...
                            <th>
                                <div class="datatable-form-filter">
                                    {{ Form::select('filter_status', array("Select Status" => "Select Status")+$status,null,array('class'=>'form-control select2-status', "id" => "filter_status","onchange" => "jQuery('#dataTableBuilder').DataTable().draw();")) }}
                                </div>
                            </th>
