                ...
                <div class="tab-pane active" id="active">
                    <table class="table datatable-basic dataTable table-hover no-footer table-bordered table-striped" id="dataTableBuilder">
                        <thead>
                            <tr>
                                <th>
                        <div class="col-sm-12 datatable-form-filter">{!! Form::text('filter_id',Request::get('filter_id',null),array('class' => 'form-control name')) !!}</div>
                        </th>
                        <th>
                        <div class="col-sm-12 datatable-form-filter">{!! Form::text('filter_email',Request::get('filter_email',null),array('class' => 'form-control name')) !!}</div>
                        </th>
                        <th>
                        <div class="col-sm-12 datatable-form-filter">{!! Form::text('filter_role',Request::get('filter_role',null),array('class' => 'form-control small')) !!}</div>
                        </th>
                        <th></th>
                        <th></th>
                        </tr>
                        <tr>
                            ...
                            <th>Role</th>
                            <th>Status</th>
                            <th class="user_action_width">Action</th>
                        </tr>
                        </thead>
                        <tbody>
        ...
        window.LaravelDataTables["dataTableBuilder"] = $("#dataTableBuilder").DataTable({
            ...
            "ajax": {
                data: function (d) {
                    ...
                    d.status = jQuery(".datatable-form-filter input[name='filter_status']").val();
                }
            },
            "columns": [{
                "name": "name",
